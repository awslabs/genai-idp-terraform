...
| <a name="input_enable_knowledge_base"></a> [enable\_knowledge\_base](#input\_enable\_knowledge\_base) | DEPRECATED: Use api.knowledge\_base.enabled instead. Enable AWS Bedrock Knowledge Base for document querying | `bool` | `null` | no |
...
| <a name="input_knowledge_base_embeddings_model_id"></a> [knowledge\_base\_embeddings\_model\_id](#input\_knowledge\_base\_embeddings\_model\_id) | DEPRECATED: Use api.knowledge\_base.embedding\_model\_id instead. Model ID for knowledge base embeddings | `string` | `null` | no |
| <a name="input_knowledge_base_model_id"></a> [knowledge\_base\_model\_id](#input\_knowledge\_base\_model\_id) | DEPRECATED: Use api.knowledge\_base.model\_id instead. Model ID for knowledge base queries | `string` | `null` | no |
