...
> **⚠️ DEPRECATION NOTICE**: The SageMaker UDOP processor (Pattern 3) is deprecated. For new deployments, use the BDA processor (Pattern 1) or Bedrock LLM processor (Pattern 2).
