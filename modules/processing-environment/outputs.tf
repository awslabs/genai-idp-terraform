...
output "post_processing_decompressor_function_arn" {
  description = "ARN of the post-processing decompressor Lambda function"
  value       = aws_lambda_function.post_processing_decompressor.arn
}

output "post_processing_decompressor_function_name" {
