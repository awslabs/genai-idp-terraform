...
| <a name="input_blueprint_arn"></a> [blueprint\_arn](#input\_blueprint\_arn) | The ARN of the Bedrock Blueprint used for document processing | `string` | `null` | no |
...
| <a name="input_evaluation_baseline_bucket"></a> [evaluation\_baseline\_bucket](#input\_evaluation\_baseline\_bucket) | Optional S3 bucket for storing evaluation baseline documents | <pre>object({<br>    bucket_name = string<br>    bucket_arn  = string<br>  })</pre> | `null` | no |
